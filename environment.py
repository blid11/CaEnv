...
#####################################################################################################################
class Environment:
    def __init__(self, sticky_action_prob = 0.1, difficulty_ramping = True, random_seed = None):
        env_module = 'cellular'
        self.game = 'cellular'
        self.sticky_action_prob = 0.1
        self.env_name = 'cellular'
        self.env = Env(ramping = difficulty_ramping, seed = random_seed)
